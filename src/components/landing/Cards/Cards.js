...
`element__basket ${props.card.owner._id === currentUser._id ? 'element__basket_active' : ''}`
);
const cardLikeButtonClassName = `element__like ${props.card.likes.some(i => i._id === currentUser._id) ? 'element__like_active' : ''}`; 
